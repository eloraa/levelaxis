    ...
    <div className="container py-18 mt-18">
      <div className="flex items-center justify-center">
        <div className="text-center max-w-3xl mx-auto">
          <h1 className="font-bold text-6xl text-secondary-500 leading-[130%]">Engineering Intelligent Technology For The Future</h1>
          <p className="mt-6">
          ...
          <div className="grid gap-5">
            ...
            <div className="flex gap-5 h-52">
              <div className="size-full bg-secondary-500 p-4 text-white flex flex-col justify-between">
                ...
                <div>
                  <p className="font-medium text-sm">Successful Projects</p>
                </div>
              </div>
              <div className="size-full bg-primary-600 p-4 text-white flex flex-col justify-between">
                <div>
                  <p className="font-medium text-sm">Industries Served</p>
                </div>
                <div className="flex items-center">
                  <h1 className="font-medium text-5xl">
          ...
          <div className="grid gap-5">
            <div className="flex gap-5 h-52">
              <div className="size-full bg-primary-600 p-4 text-white flex flex-col justify-between">
                ...
                <div>
                  <p className="font-medium text-sm">Technology Experts</p>
                </div>
              </div>
              <div className="size-full bg-secondary-500 p-4 text-white flex flex-col justify-between">
                <div>
                  <p className="font-medium text-sm">Client Satisfaction</p>
                </div>
                <div className="flex items-center">
                  <h1 className="font-medium text-5xl">99%</h1>
                </div>
              </div>
            </div>
            <div className="h-86">
